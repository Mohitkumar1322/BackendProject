...
* sqllite cli-> we are using this for easy orm have bunch of commands which help tp directly to do some sql operations*  we are applying in src folder wherre sequelize cli can be used and intialise in folder src we use npx sequelize 
